...
__all__ = ["ResNet", "l_resnet50", "l_resnet101"]

model_urls = {
    "resnet50": "http://cs.jhu.edu/~syqiao/WeightStandardization/R-50-GN-WS.pth.tar",
    "resnet101": "http://cs.jhu.edu/~syqiao/WeightStandardization/R-101-GN-WS.pth.tar",
}


def conv3x3(in_planes, out_planes, stride=1):
    """3x3 convolution with padding"""
    return L.Conv2d(in_planes, out_planes, kernel_size=3, stride=stride, padding=1, bias=False)
...
def l_resnet50(pretrained=False, **kwargs):
    ...
    if pretrained:
        L.load_pretrained_params(model, model_url=model_urls["resnet50"])
    return model
